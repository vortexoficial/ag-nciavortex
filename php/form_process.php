...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST['action']) and $_POST['action'] === 'question') {
        $name = $_POST['name'];
        $email = $_POST["email"];
        $message = $_POST["message"];
        $subject = "Subject Question"; // Replace your Subject Here
        ...
        $subject = "Subject Subscribe"; // Replace your Subject Here
        ...
        $email = $_POST["email"];
        $message = $_POST["message"];
        $subject = "Subject Email Message"; // Replace your Subject Here
